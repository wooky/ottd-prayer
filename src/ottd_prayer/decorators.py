...
def data_consumer(func: Callable[[memoryview], Receive]) -> Callable[..., dict[str, Any]]:
...
def app_consumer(logger: logging.Logger) -> Callable[..., Callable[..., Coroutine[Any, Any, None]]]:
    def decorator(func: Callable[Concatenate[T, P], Coroutine[Any, Any, None]]) -> Callable[P, Coroutine[Any, Any, None]]:
        @wraps(func)
